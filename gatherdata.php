...
//   if($debug == 2){echo 'cexo | '.$pair.'<br>value: '.$val.' <br>volume: '.$vol.' <br>timestamp: '.timeStamp().':00<hr>';}
...
foreach($polx_data as $key => $value){
  ...
  if($debug == 2){echo 'polx | '.$pair.'<br>value: '.$val.' <br>volume: '.$vol.' <br>timestamp: '.timeStamp().':00<hr>';}
